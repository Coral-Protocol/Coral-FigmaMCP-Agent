...
async def main():
    ...
    coral_params = {
        "agentId": agentID,
        "agentDescription": "figma_mcp agent capable of extracting code, variable definitions, and connection mappings from Figma design nodes, generating images from design elements, and creating design system rules tailored to client programming languages and frameworks."
    }
    ...
    agent_tools = await client.get_tools(server_name='figma_mcp')
